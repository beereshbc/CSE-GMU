...
const StudentAchievements = () => {
  useEffect(() => {
    ...
    const focusableElements = document.querySelectorAll('.achievement-card, .gallery-item, .read-more-btn');
  ...
  const studentAchievements = [
    {
      ...
      description: "Under the leadership of DS Yashaswini, our team created an impactful Generative AI solution aimed at enhancing health and well-being during an intense 24-hour challenge in Hyderabad.",
      hasLink: true
    },
    {
      id: 2,
      ...
      department: "Computer Science",
      description: "Took part in a paper presentation at KLE Institute of Technology, Hubli, on 'The Role of Individuals in Combating Climate Change'.",
      hasLink: false
    },
    {
      id: 3,
      ...
      students: "Innovators",
      department: "",
      description: "Ideathon 2025 was held at Jain College Davangere on 23rd of April for analysis of future stocks and prediction of stocks.",
      hasLink: true
    },
    {
      id: 4,
      ...
      description: "This project focuses on developing an AI-based system that detects hand signs and translates them into text in real time.",
      hasLink: false
    },
    {
      id: 5,
      image: "https://images.unsplash.com/photo-1551836026-d5c88ac5c73d?w=600&h=400&fit=crop",
      title: "NeuroCalm Project – National Hackathon",
      students: "Sachin, Abhiram, Prajwal, Sudharshan",
      department: "",
      description: "Our students participated in the National Hackathon at Presidency University with their project NeuroCalm, an innovative solution for mental well-being.",
      hasLink: false
    },
    {
      id: 6,
      ...
      department: "",
      description: "The AI-Powered Investment Exit Strategy Predictor helps investors make smarter, data-driven exit decisions.",
      hasLink: false
    },
    {
      id: 7,
      ...
      department: "",
      description: "At Hackmitten 2.0, our team developed Code Quality Visualizer—a tool for static analysis of code repositories.",
      hasLink: false
    },
    {
      id: 8,
      ...
      department: "Computer Science",
      description: "Developed an AI-powered campus navigation system that helps students navigate efficiently using augmented reality.",
      hasLink: true
    },
    {
      id: 9,
      ...
      description: "Implemented a blockchain solution for secure and tamper-proof verification of academic certificates.",
      hasLink: true
    },
    {
      id: 10,
      ...
      description: "Created an IoT-based smart agriculture monitoring system for real-time crop health monitoring.",
      hasLink: false
    },
    {
      id: 11,
      ...
      description: "Developed a machine learning model that assists in early diagnosis of diseases using medical imaging.",
      hasLink: true
    },
    {
      id: 12,
      ...
      description: "Built a comprehensive dashboard for monitoring renewable energy consumption across campus.",
      hasLink: false
    }
  ];
  ...
  const galleryImages = [
    {
      ...
      largeSrc: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&h=600&fit=crop',
    ...
    },
    {
      ...
      largeSrc: 'https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?w=800&h=600&fit=crop',
    ...
    },
    {
      ...
      largeSrc: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&h=600&fit=crop',
      title: 'International Research Conference',
      description: 'Students presenting groundbreaking research'
    },
    {
      src: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=300&fit=crop',
      largeSrc: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=600&fit=crop',
    ...
    },
    {
      ...
      largeSrc: 'https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800&h=600&fit=crop',
    ...
    },
    {
      ...
      largeSrc: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&h=600&fit=crop',
      title: 'Scholarship Award Ceremony',
      description: 'Recognizing academic excellence'
    },
    {
      src: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=400&h=300&fit=crop',
      largeSrc: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&h=600&fit=crop',
    ...
    },
    {
      ...
      largeSrc: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=800&h=600&fit=crop',
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our students' remarkable accomplishments across academics, innovation, and entrepreneurship
            </p>
          </div>
            ...
            {studentAchievements.map((achievement) => (
              ...
              >
                ...
                <div className="card-content p-6 flex-1 flex flex-col">
                  ...
                  {achievement.hasLink && (
                    <a href="#" className="read-more-btn inline-flex items-center gap-2 text-blue-600 font-semibold text-sm hover:text-blue-800 transition-all duration-300 border-b-2 border-transparent hover:border-yellow-500 mt-auto">
                      {achievement.id === 3 ? (
            ...
            {galleryImages.map((item, index) => (
              ...
              >
                ...
                <div className="gallery-overlay absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent text-white p-6">
                  <div className="gallery-title font-semibold text-lg mb-1">{item.title}</div>
                  <div className="gallery-description text-sm opacity-90">{item.description}</div>
                </div>
              </div>
            ))}
          </div>
