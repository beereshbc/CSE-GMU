...
const FacultyAchievements = () => {
  ...
  const achievementData = [
    {
      ...
      description: "Our faculty have published numerous research papers in reputed journals, contributing to advancements in computer science and technology."
    },
    {
      id: 2,
      badgeIcon: "fas fa-lightbulb",
      badgeText: "Innovation",
      imageSrc: "https://images.unsplash.com/photo-1516321310762-479e93c67b9f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      imageAlt: "AI/ML Projects",
      title: "Guiding Projects & Innovation",
      description: "Faculty guide students in cutting-edge projects in AI, ML, IoT, and Cybersecurity, fostering innovation and practical learning."
    },
    {
      id: 3,
      badgeIcon: "fas fa-graduation-cap",
      badgeText: "Academic",
      imageSrc: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      imageAlt: "Curriculum Development",
      title: "Academic Quality Initiatives",
      description: "Our faculty contribute to curriculum development, NBA/OBE practices, and IQAC activities to ensure academic excellence."
    },
    {
      id: 4,
      badgeIcon: "fas fa-handshake",
      badgeText: "Collaboration",
      imageSrc: "https://images.unsplash.com/photo-1556741533-6e6a62bd8b49?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      imageAlt: "Industry Collaboration",
      title: "Industry Collaboration & Grants",
      description: "Faculty secure research grants and collaborate with industries to bridge the gap between academia and practice."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white" style={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      ...
      >
        <div className="container max-w-4xl mx-auto px-4">
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Faculty members of the Department of CSE have consistently contributed to research, innovation, and academic excellence. They have published research papers in reputed journals, guided student projects in cutting-edge areas like AI, ML, IoT, and Cybersecurity, and actively engaged in academic quality initiatives such as curriculum development, NBA/OBE practices, and IQAC activities.
          </motion.p>
        </div>
      </motion.section>
        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-700 max-w-2xl mx-auto">
              Discover the remarkable achievements of our CSE faculty in research, innovation, and academic excellence.
            </p>
          </motion.div>
      ...
      >
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Be part of our innovative community where faculty achievements drive technological advancement and academic excellence.
          </motion.p>
          <motion.button
